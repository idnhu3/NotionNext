...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '25397e8aa15345efaa575114661ec6b2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'idnhu3', // 您的昵称 例如
  BIO: process.env.NEXT_PUBLIC_BIO || '一个努力的打工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-410xxm7px-idnhu3-163com.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'idnhu3@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/idnhu3', // 你的github个人主页 例如 https://github.com/tangly1024
